...
The answer is simple, and harsh. The market did not `reward` saving the lives of these children, and governments did not `subsidize` it. So the children died because thrie mothers and their fathers had no power in the market and no voice in the system.
